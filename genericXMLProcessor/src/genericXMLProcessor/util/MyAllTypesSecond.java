...
public class MyAllTypesSecond extends SerializableObject{
	...
	public MyAllTypesSecond(){
		Debug.printDebug(1, "In Class MyAllTypesSecond's (Default)Constructor");
	}
	...
	public MyAllTypesSecond(int myIntSIN, String myStringSIN, float myFloatSIN, short myShortSIN, char myCharSIN){		
		Debug.printDebug(1, "In Class MyAllTypesSecond's (Parameterised)Constructor");
