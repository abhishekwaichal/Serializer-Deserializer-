...
public class Driver
{
	...
	public static void main(String[] args)
	{
		...
		Debug.setDebugValue(Integer.parseInt(args[0]));

		if (Debug.getDebugValue() < 0 || Debug.getDebugValue() > 1) {
		...
		if(myF.equals(myFret))
			Debug.printDebug(0, "MyAllTypesFirst comparison successful !");
		else
			Debug.printDebug(0, "MyAllTypesFirst comparison unsuccessful !");
		...
		if(myS.equals(mySret))
			Debug.printDebug(0, "MyAllTypesSecond comparison successful !");
		else
			Debug.printDebug(0, "MyAllTypesSecond comparison unsuccessful !");
